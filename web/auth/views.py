...
def register(request):
  ...
  """
    ...
    return render(request, "auth/registration.html", {"form": form, "captcha_form": captcha_form})
...
def reset_password(request):
    ...
    return render(request, "auth/reset-password/reset-password-1.html", {"form": form})
