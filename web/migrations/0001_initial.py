...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('importer_access', 'Can act as an importer'), ('exporter_access', 'Can act as an exporter'), ('reference_data_access', 'Can maintain reference data'), ('mailshot_access', 'Can maintain mailshots')),
                'managed': False,
                'default_permissions': [],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_active', models.BooleanField(default=True)),
                ('type', models.CharField(choices=[('INDIVIDUAL', 'Individual'), ('ORGANISATION', 'Organisation')], max_length=20, verbose_name='Entity Type')),
                ('name', models.TextField(blank=True, default='', verbose_name='Organisation Name')),
                ('registered_number', models.CharField(blank=True, max_length=15, null=True, verbose_name='Registered Number')),
                ('eori_number', models.CharField(blank=True, help_text='EORI number should include the GB prefix', max_length=20, null=True, verbose_name='EORI Number')),
                ('eori_number_ni', models.CharField(blank=True, max_length=20, null=True, verbose_name='NI EORI Number')),
            ...
            options={
                'ordering': ('-is_active', 'name'),
                'permissions': [('is_contact_of_importer', 'Is contact of this importer'), ('is_agent_of_importer', 'Is agent of this importer')],
            },
            bases=(web.models.mixins.Archivable, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('process_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='web.process')),
                ('status', models.CharField(choices=[('IN_PROGRESS', 'In Progress'), ('SUBMITTED', 'Submitted'), ('PROCESSING', 'Processing'), ('COMPLETED', 'Completed'), ('WITHDRAWN', 'Withdrawn'), ('STOPPED', 'Stopped'), ('REVOKED', 'Revoked'), ('VARIATION', 'Case Variation'), ('DELETED', 'Deleted')], default='IN_PROGRESS', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('finished', models.DateTimeField(blank=True, null=True)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='web.user')),
                ('previous', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='next', to='web.task')),
                ('process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='web.process')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='importer',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='own_importers', to='web.user', verbose_name='Person'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-is_active', 'name'),
                'permissions': [('is_contact_of_exporter', 'Is contact of this exporter'), ('is_agent_of_exporter', 'Is agent of this exporter')],
            },
            bases=(web.models.mixins.Archivable, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='web.importapplication')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('exportapplication_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='web.exportapplication')),
        ...
        migrations.AddField(
            ...
            name='agent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='agent_export_applications', to='web.exporter'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='agent_office',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='agent_office_export_applications', to='web.office'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='application_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='web.exportapplicationtype'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='case_notes',
        ...
        migrations.AddField(
            model_name='exportapplication',
            name='case_owner',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='web.user'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='contact',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='contact_export_applications', to='web.user'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='countries',
        ...
        migrations.AddField(
            model_name='exportapplication',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='created_export_applications', to='web.user'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='exporter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='export_applications', to='web.exporter'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='exporter_office',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='office_export_applications', to='web.office'),
        ),
        migrations.AddField(
            model_name='exportapplication',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='updated_export_cases', to='web.user'),
        ),
        migrations.AddField(
            model_name='exportapplication',
            name='submitted_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='submitted_export_application', to='web.user'),
        ),
        migrations.AddField(
            model_name='exportapplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation_registered_number', models.CharField(blank=True, default='', max_length=100, verbose_name='Registered Number')),
                ('request_reason', models.TextField(verbose_name='What are you importing and where are you importing it from?')),
                ...
                ('further_information_requests', models.ManyToManyField(to='web.FurtherInformationRequest')),
                ('last_updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_access_requests', to='web.user')),
                ('submitted_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='submitted_access_requests', to='web.user')),
            ],
            bases=(web.domains.workbasket.base.WorkbasketBase, 'web.process'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('accessrequest_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='web.accessrequest')),
                ('eori_number', models.CharField(blank=True, default='', help_text='EORI number should include the GB prefix for organisation or GBPR for individual', max_length=20, verbose_name='EORI Number')),
                ('eori_number_ni', models.CharField(blank=True, default='', max_length=20, verbose_name='NI EORI Number')),
                ('request_type', models.CharField(choices=[('MAIN_IMPORTER_ACCESS', 'Request access to act as an Importer'), ('AGENT_IMPORTER_ACCESS', 'Request access to act as an Agent for an Importer')], max_length=30, verbose_name='Access Request Type')),
                ('link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='access_requests', to='web.importer')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('accessrequest_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='web.accessrequest')),
                ('request_type', models.CharField(choices=[('MAIN_EXPORTER_ACCESS', 'Request access to act as an Exporter'), ('AGENT_EXPORTER_ACCESS', 'Request access to act as an Agent for an Exporter')], max_length=30, verbose_name='Access Request Type')),
                ('link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='access_requests', to='web.exporter')),
            ],
            bases=('web.accessrequest',),
        ),
    ]
