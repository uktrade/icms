# Generated by Django 4.2.11 on 2024-04-22 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("organisation", models.CharField(blank=True, max_length=4000, null=True)),
                ("department", models.CharField(blank=True, max_length=4000, null=True)),
                ("job_title", models.CharField(blank=True, max_length=320, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reference",
                    models.CharField(max_length=20, null=True, verbose_name="Document Reference"),
                ),
                ("check_code", models.CharField(max_length=16, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=70, verbose_name="Template Name")),
                (
                    "description",
                    models.CharField(max_length=500, verbose_name="Template Description"),
                ),
                (
                    "application_type",
                    models.CharField(
                        ...
                        help_text="DIT does not issue Certificates of Free Sale for food, food supplements, pesticides and CE marked medical devices. Certificates of Manufacture are applicable only to pesticides that are for export only and not on free sale on the domestic market.",
                        max_length=3,
        ...
        migrations.CreateModel(
            name="CertificateOfGoodManufacturingPracticeApplicationTemplate",
            fields=[
                (
                    "id",
                    models.AutoField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=4000,
                        null=True,
                        verbose_name="End Use or Final Product",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("SCHEDULE_INTRODUCTION", "Schedule Introduction"),
                            ("IS_MANUFACTURER", "Is Manufacturer"),
                            ("IS_NOT_MANUFACTURER", "Is not Manufacturer"),
                            ("EU_COSMETICS_RESPONSIBLE_PERSON", "EU Cosmetics Responsible Person"),
                            (
                                "EU_COSMETICS_RESPONSIBLE_PERSON_NI",
                                "EU Cosmetics Responsible Person NI",
                            ),
                            ("LEGISLATION_STATEMENT", "Legislation Statement"),
                            ("ELIGIBILITY_ON_SALE", "Eligibility on Sale"),
                            ("ELIGIBILITY_MAY_BE_SOLD", "Eligibility May Be Sold"),
                            ("GOOD_MANUFACTURING_PRACTICE", "Good Manufacturing Practice"),
                            ("GOOD_MANUFACTURING_PRACTICE_NI", "Good Manufacturing Practice NI"),
                            ("COUNTRY_OF_MAN_STATEMENT", "Country of Manufacture Statement"),
                            (
        ...
        migrations.CreateModel(
            name="ChiefRequestResponseErrors",
            fields=[
                (
                    "id",
                    models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=4000, unique=True, verbose_name="Group Name")),
                (
                    "comments",
                    models.CharField(
                        blank=True, max_length=4000, null=True, verbose_name="Group Comments"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=4000,
                        null=True,
                        verbose_name="If you are not importing any firearms against this import licence then please specify why in the text box and then confirm reporting complete.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model",
                    models.CharField(max_length=400, null=True, verbose_name="Make and Model"),
                ),
                (
                    "proofing",
                    models.CharField(
        ...
        migrations.CreateModel(
            name="ExportApplicationCertificate",
            fields=[
                (
                    "id",
                    models.AutoField(
                ...
                (
                    ...
                    models.DateTimeField(null=True, verbose_name="Issue Date"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            name="ExportCertificateCaseDocumentReferenceData",
            fields=[
                (
                    "id",
                    models.AutoField(
        ...
        migrations.CreateModel(
            name="ExporterUserObjectPermission",
            fields=[
                (
                    "id",
                    models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("P", "With CHIEF (Pending)"),
                            ("S", "CHIEF Success"),
                            ("E", "CHIEF Error"),
                            ("I", "Internal error sending data to CHIEF"),
                        ],
                        default="P",
                        max_length=1,
                    ),
                ...
                (
                    "request_data",
                    models.JSONField(default=dict, encoder=web.models.shared.EnumJsonEncoder),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("licence_start_date", models.DateField(null=True, verbose_name="Start Date")),
                ("licence_end_date", models.DateField(null=True, verbose_name="End Date")),
                (
                    "case_completion_datetime",
                    models.DateTimeField(null=True, verbose_name="Case Completion Date"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "permissions": (
                    (
                        "view_importer",
                        "Can view all applications and licences for a particular importer",
                    ),
                    (
                        "edit_importer",
        ...
        migrations.CreateModel(
            name="ImporterUserObjectPermission",
            fields=[
                (
                    "id",
                    models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Optionally send emails to the selected recipients. Note that uploaded documents will not be attached to the email.",
                ...
                (
                    "email_body",
                    models.CharField(max_length=4000, null=True, verbose_name="Email Body"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "eori_number",
                    models.CharField(
                        blank=True, max_length=20, null=True, verbose_name="Override EORI Number"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Product type numbers and active ingredients must be entered by the applicant when biocidal legislation is selected",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="A 'responsible person' statement may be added to the issued certificate schedule when the applicant selects EU Cosmetics Regulation legislation",
                        verbose_name="Cosmetics Regulation",
                    ),
                ),
                (
                    "is_biocidal_claim",
                    models.BooleanField(default=False, verbose_name="Biocidal Claim"),
                ),
                (
                    "gb_legislation",
                    models.BooleanField(default=True, verbose_name="GB Legislation"),
                ),
                (
                    "ni_legislation",
                    models.BooleanField(default=True, verbose_name="NI Legislation"),
                ),
            ],
            options={
                "ordering": ("-is_active", "name"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Value (GBP CIF)"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "obsolete_calibre",
                    models.CharField(max_length=200, verbose_name="Obsolete Calibre"),
                ),
                (
                    "description",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.PositiveBigIntegerField(help_text="Enter a whole number", null=True),
                ),
                (
                    "unlimited_quantity",
                    models.BooleanField(default=False, verbose_name="Unlimited Quantity"),
                ...
                (
                    "obsolete_calibre",
                    models.CharField(max_length=200, null=True, verbose_name="Obsolete Calibre"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name="SILSupplementaryReportFirearmSectionLegacy",
            fields=[
                (
                    "id",
                    models.AutoField(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("prepare", "Prepare"),
                            ("process", "Process"),
                            ("vr_request_change", "VR_REQUEST_CHANGE"),
                            ("authorise", "Authorise"),
                            ("document_error", "Digital signing error"),
                            ("document_signing", "Digital signing"),
                            ("chief_wait", "CHIEF_WAIT"),
                            ("chief_revoke_wait", "CHIEF_REVOKE_WAIT"),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("IMA", "Import App"),
                            ("ILD", "Import Licence Document"),
                            ("CFS", "Export Certificate Document Cfs"),
                            ("COM", "Export Certificate Document Com"),
                            ("GMP", "Export Certificate Document Gmp"),
                            ("GA", "Export App Ga"),
                            ("CA", "Export App Ca"),
                            ("MAIL", "Mailshot"),
                            ("IAR", "Imp Access Req"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "refuse_reason",
                    models.CharField(
                        blank=True, max_length=4000, null=True, verbose_name="Refusal reason"
                    ),
                ),
                ("last_update_datetime", models.DateTimeField(auto_now=True)),
            ],
            bases=("web.process", models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("response_detail", models.TextField(null=True, verbose_name="Response Detail")),
                ("response_datetime", models.DateTimeField(null=True)),
                ("closed_datetime", models.DateTimeField(null=True)),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=4000,
                        null=True,
                        verbose_name="Variation Refusal Reason",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=4000,
                        verbose_name="What would you like to vary about the current licence(s)",
                    ),
                ),
                (
                    "why_varied",
                ...
                (
                    ...
                    models.CharField(
                        max_length=4000,
                        null=True,
                        verbose_name="Description of the changes required",
                    ),
                ),
                ("closed_datetime", models.DateTimeField(null=True)),
                (
        ...
        migrations.AddField(
            ...
            name="process",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="tasks", to="web.process"
            ),
        ),
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsectionlegacy",
            name="document",
        ...
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsectionlegacy",
            name="goods_certificate",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="supplementary_report_firearms",
                to="web.sillegacygoods",
            ),
        ),
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsectionlegacy",
        ...
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection582other",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="supplementary_report_firearms",
                to="web.silgoodssection582other",
            ),
        ),
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection582other",
        ...
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection582obsolete",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="supplementary_report_firearms",
                to="web.silgoodssection582obsolete",
            ),
        ),
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection582obsolete",
        ...
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection5",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection2",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name="silsupplementaryreportfirearmsection1",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name="oilsupplementaryreportfirearm",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name="mailshot",
            name="documents",
            field=models.ManyToManyField(related_name="+", to="web.file"),
        ),
        migrations.AddField(
            model_name="mailshot",
            name="published_by",
        ...
        migrations.AddField(
            model_name="importeruserobjectpermission",
            name="content_object",
        ...
        migrations.AddField(
            model_name="importergroupobjectpermission",
            name="content_object",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="web.importer"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="country",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="+", to="web.country"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="document",
            field=models.OneToOneField(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="web.file"
            ),
        ),
        migrations.AddField(
            model_name="generatedreport",
        ...
        migrations.AddField(
            model_name="exporteruserobjectpermission",
            name="content_object",
        ...
        migrations.AddField(
            model_name="exportergroupobjectpermission",
            name="content_object",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="web.exporter"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name="exportcertificatecasedocumentreferencedata",
            name="case_document_reference",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="reference_data",
                to="web.casedocumentreference",
            ),
        ),
        migrations.AddField(
            model_name="exportcertificatecasedocumentreferencedata",
            name="country",
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="web.country"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name="dflsupplementaryreportfirearm",
            name="document",
            field=models.OneToOneField(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name="chiefrequestresponseerrors",
            name="request",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                related_name="response_errors",
                to="web.icmshmrcchiefrequest",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="schedules",
                to="web.certificateoffreesaleapplicationtemplate",
            ),
        ),
        migrations.AddField(
            model_name="cfsscheduletemplate",
        ...
        migrations.AddField(
            ...
            name="legislations",
            field=models.ManyToManyField(
                help_text="Enter legislation relevant to the products on this schedule. A maximum of 3 pieces of legislation may be added per schedule. If you cannot find relevant legislation, please contact DIT, enquiries.ilb@trade.gov.uk, to request to have it added.",
        ...
        migrations.AddField(
            model_name="certificateofmanufactureapplicationtemplate",
            name="countries",
            field=models.ManyToManyField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                to="web.certificateapplicationtemplate",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="gmp_template",
                to="web.certificateapplicationtemplate",
            ),
        ),
        migrations.AddField(
            model_name="certificateoffreesaleapplicationtemplate",
            name="countries",
            field=models.ManyToManyField(
                help_text="A certificate will be created for each country selected. You may select up to 40 countries. You cannot select the same country twice, you must submit a new application.",
                to="web.country",
        ...
        migrations.CreateModel(
            ...
            bases=("web.exportapplication", models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        help_text=(
                            "Date upon which the contract was signed. Please check the relevant Notice to Importers or Guidance that these dates are within the derogation period allowed.",
                        ),
                        null=True,
                ...
                (
                    ...
                    models.DateField(
                        help_text="Date upon which the contract will be completed. A copy of the contract is required as proof. Please check the relevant Notice to Importers or Guidance that these dates are within the derogation period allowed.",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value_eur",
                    models.PositiveBigIntegerField(null=True, verbose_name="Value (EUR/€)"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "section_legacy",
                    models.BooleanField(default=False, verbose_name="Unknown Section"),
                ),
                (
                    "other_description",
                    models.CharField(
        ...
        migrations.AddField(
            ...
            name="import_application",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="web.importapplication"
            ),
        ),
        migrations.AddConstraint(
            model_name="importapplicationtype",
            constraint=models.UniqueConstraint(
                fields=("type", "sub_type"), name="unique_import_app_type"
            ),
        ),
        migrations.AddField(
            model_name="importapplicationlicence",
        ...
        migrations.AddField(
            model_name="importapplication",
            name="case_emails",
            field=models.ManyToManyField(related_name="+", to="web.caseemail"),
        ),
        migrations.AddField(
            model_name="importapplication",
            name="case_notes",
        ...
        migrations.AddField(
            model_name="importapplication",
            name="sigl_transmissions",
            field=models.ManyToManyField(to="web.sigltransmission"),
        ),
        migrations.AddField(
            model_name="importapplication",
            name="submitted_by",
        ...
        migrations.AddField(
            model_name="icmshmrcchiefrequest",
            name="import_application",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="chief_references",
                to="web.importapplication",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name="exportcertificatecasedocumentreferencedata",
            constraint=models.UniqueConstraint(
                fields=("case_document_reference", "country"), name="cert_doc_ref_data_unique"
            ),
        ),
        migrations.AddField(
            model_name="exportapplicationcertificate",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name="+", to="web.woodcontractfile"),
        ),
        migrations.AddField(
            model_name="woodquotaapplication",
            name="supporting_documents",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name="+", to="web.section5authority"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="commodity",
            field=models.ForeignKey(
                help_text="It is the responsibility of the applicant to ensure that the commodity code in this box is correct. If you are unsure of the correct commodity code, consult the HM Revenue & Customs at classification.enquiries@hmrc.gov.uk or use the online trade tariff https://www.gov.uk/trade-tariff/sections.",
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                related_name="+",
                to="web.commodity",
        ...
        migrations.AddField(
            model_name="outwardprocessingtradeapplication",
            name="documents",
            field=models.ManyToManyField(related_name="+", to="web.outwardprocessingtradefile"),
        ),
        migrations.AddField(
            model_name="outwardprocessingtradeapplication",
        ...
        migrations.AddField(
            model_name="ironsteelapplication",
            name="certificates",
            field=models.ManyToManyField(related_name="+", to="web.ironsteelcertificatefile"),
        ),
        migrations.AddField(
            model_name="ironsteelapplication",
            name="commodity",
        ...
        migrations.AddIndex(
            model_name="importapplication",
            index=models.Index(fields=["status"], name="IA_status_idx"),
        ),
        migrations.AddIndex(
            model_name="importapplication",
            index=django.contrib.postgres.indexes.BTreeIndex(
        ...
        migrations.AddIndex(
            model_name="furtherinformationrequest",
            index=models.Index(fields=["status"], name="FIR_status_idx"),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="exportapplication",
            index=models.Index(fields=["status"], name="EA_status_idx"),
        ),
        migrations.AddIndex(
            model_name="exportapplication",
            index=django.contrib.postgres.indexes.BTreeIndex(
        ...
        migrations.AddIndex(
            model_name="exportapplication",
            index=models.Index(fields=["-submit_datetime"], name="EA_submit_datetime_idx"),
        ),
        migrations.AddField(
            model_name="dflsupplementaryinfo",
            name="import_application",
        ...
        migrations.AddIndex(
            model_name="approvalrequest",
            index=models.Index(fields=["status"], name="AppR_status_idx"),
        ),
        migrations.AddIndex(
            model_name="accessrequest",
            index=models.Index(fields=["status"], name="AccR_status_idx"),
        ),
    ]
