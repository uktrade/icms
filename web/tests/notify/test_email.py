...
class TestEmail(TestCase):
        ...
        for member in members:
            ...
            for m in member['personal']:
                PersonalEmail(user=user,
                              email=m['email'],
                              portal_notifications=m['notify']).save()
    ...
    def create_individual_importer(self, name=None, active=True, user=None):
        ...
        ImporterFactory(is_active=active,
                        user=_user,
                        name=name,
                        type=Importer.INDIVIDUAL)
        for m in user['personal']:
            PersonalEmail(user=_user,
                          email=m['email'],
                          portal_notifications=m['notify']).save()
    ...
    def setup_importers(self):
        ...
        self.create_importer_org(
            ...
            members=[{
                ...
                'alternative': [{
                    'email': 'active_org_user_alt@example.com',
                    'notify': True
                }, {
                    'email': 'active_org_user_alt_no_notify@example.com',
                    'notify': False
                }]
            }, {
                'active':
                ...
                False,
                'personal': [{
                    'email': 'deactive_org_user@example.com',
                    'notify': True
                }]
            }])
        ...
        self.create_individual_importer(
            ...
            user={
                ...
                True,
                'personal': [{
                    'email': 'ind_importer_user@example.com',
                    'notify': True
                }, {
                    'email': 'ind_importer_no_notify@example.com',
                    'notify': False
                }]
            })
        ...
        self.create_individual_importer(
            ...
            user={
                ...
                True,
                'personal': [{
                    'email': 'deactive_ind_importer_user@example.com',
                    'notify': True
                }, {
                    'email': 'deactive_ind_importer_no_notify@example.com',
                    'notify': False
                }]
            })
    ...
    def setup_exporters(self):
        ...
        self.create_exporter(
            ...
            members=[{
                ...
                True,
                'personal': [{
                    'email': 'active_export_user@example.com',
                    'notify': True
                }, {
                    'email': 'active_export_user_no_notify@example.com',
                    'notify': False
                }],
                'alternative': [{
                    'email': 'active_export_user_alt@example.com',
                    'notify': True
                }, {
                    'email': 'active_export_user_alt_no_notify@example.com',
                    'notify': False
                }]
            }, {
                'active':
                True,
                'personal': [{
                    'email': 'second_active_export_user@example.com',
                    'notify': True
                }]
            }, {
                'active':
                False,
                'personal': [{
                    'email': 'deactive_export_user@example.com',
                    'notify': True
                }]
            }])
            ...
            members=[
                {
                    ...
                    True,
                    'personal': [{
                        'email': 'archived_export_user@example.com',
                        'notify': True
                    }],
                    'alternative': [{
                        'email': 'archived_export_user_alt@example.com',
                        'notify': True
                    }]
                },
            ])
    ...
    def test_send_email(self):
        email.send_email.delay('Test subject',
                               'Test message',
