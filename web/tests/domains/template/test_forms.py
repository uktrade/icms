...
from web.domains.template.forms import (EndorsementCreateTemplateForm,
                                        GenericTemplate, TemplatesFilter)
...
class TemplatesFilterTest(TestCase):
    def setUp(self):
        TemplateFactory(template_name='Archived Endorsement',
    ...
    def test_template_type_filter(self):
        ...
        self.assertEqual(results.first().template_name,
