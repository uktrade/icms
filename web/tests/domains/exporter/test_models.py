...
class ExporterTest(TestCase):
    ...
    def test_agent_approve_reject_role_has_default_permissions(self):
        Permission.objects.create(codename='IMP_CERT_AGENT_APPROVER',
                                  content_type_id=15)
        Permission.objects.create(codename='IMP_CERT_SEARCH_CASES_LHS',
                                  content_type_id=15)
        Permission.objects.create(codename='MAILSHOT_RECIPIENT',
                                  content_type_id=15)
        exporter = self.create_exporter()
        role_name = f'Exporter Contacts:Approve/Reject Agents and Exporters:{exporter.id}'
    ...
    def test_application_edit_role_has_default_permissions(self):
        Permission.objects.create(codename='IMP_CERT_EDIT_APPLICATION',
                                  content_type_id=15)
        Permission.objects.create(codename='IMP_CERT_SEARCH_CASES_LHS',
                                  content_type_id=15)
        Permission.objects.create(codename='MAILSHOT_RECIPIENT',
    ...
    def test_application_view_role_has_default_permissions(self):
        Permission.objects.create(codename='IMP_CERT_VIEW_APPLICATION',
                                  content_type_id=15)
        Permission.objects.create(codename='IMP_CERT_SEARCH_CASES_LHS',
                                  content_type_id=15)
        Permission.objects.create(codename='MAILSHOT_RECIPIENT',
