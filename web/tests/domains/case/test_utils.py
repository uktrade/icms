...
def test_digits(lock_manager):
    ...
    ref1 = reference.get_next_reference(lock_manager, prefix="blaa", use_year=False, min_digits=0)
    assert ref1 == "blaa/1"

    ref2 = reference.get_next_reference(lock_manager, prefix="blaa", use_year=False, min_digits=5)
...
def test_digits_overflow(lock_manager):
    ...
    ref = reference.get_next_reference(lock_manager, prefix="bluu", use_year=False, min_digits=2)
    assert ref == "bluu/501"
...
def test_year(lock_manager):
    ...
    ref1 = reference.get_next_reference(lock_manager, prefix="blii", use_year=True, min_digits=3)
    assert ref1 == f"blii/{year}/001"

    ref2 = reference.get_next_reference(lock_manager, prefix="blii", use_year=True, min_digits=4)
