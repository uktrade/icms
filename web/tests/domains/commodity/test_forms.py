...
class CommodityGroupFilterTest(TestCase):
    def setUp(self):
        CommodityGroupFactory(
            ...
            group_description='Archived group').commodities.add(
                CommodityFactory(is_active=True, commodity_code='12345678'))
        CommodityGroupFactory(
            is_active=True,
            group_code='13',
            group_name='Active Group 1',
            group_type=CommodityGroup.CATEGORY,
            group_description='First active commodity group').commodities.add(
                CommodityFactory(is_active=True, commodity_code='987654'))
        CommodityGroupFactory(
            is_active=True,
            group_code='12',
            group_name='Active Group 2',
            group_type=CommodityGroup.AUTO,
            group_description='Second active commodity group').commodities.add(
                CommodityFactory(is_active=True, commodity_code='5151515151'))
