...
def test_fa_dfl_licence_data_can_serialise_using_enum_json_encoder():
    ...
    dict_data = create_licence_data.model_dump()
...
def test_gbpr_is_valid_org_eori_number():
    """DjangoJSONEncoder doesn't know how to encode enums.
...
def _get_organisation(today: dt.date, eori: str = "GB123456789012345") -> types.OrganisationData:
