...
class SILApplication(ImportApplication):
    ...
    section_ni = models.BooleanField(verbose_name="Movements into Northern Ireland", default=False)
...
class SILGoodsSectionBase(models.Model):
    ...
    # Original applicant fields that cannot be overritten by the case officer
