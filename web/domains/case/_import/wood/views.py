...
from web.models import Task, User, WoodQuotaApplication, WoodQuotaChecklist
...
def check_can_edit_application(user: User, application: WoodQuotaApplication) -> None:
