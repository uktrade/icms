...
class ProductLegislation(Archivable, models.Model):
    ...
    is_eu_cosmetics_regulation = models.BooleanField(blank=False, null=False, default=False)
    is_biocidal_claim = models.BooleanField(blank=False, null=False, default=False)
