...
from .forms import (
    ObsoleteCalibreGroupDisplayForm,
    ObsoleteCalibreGroupEditForm,
...
class ObsoleteCalibreListView(PostActionMixin, ModelFilterView):
    ...
    class Display:
        ...
        fields_config = {
            "name": {"header": "Obsolete Calibre Group Name"},
            "calibres__count": {
...
class ObsoleteCalibreGroupBaseView(PostActionMixin):
    def get_formset(self):
        ...
        return new_calibres_formset(
            self.object, queryset=queryset, data=self.request.POST or None, extra=extra
        )
...
class ObsoleteCalibreGroupEditView(ObsoleteCalibreGroupBaseView, ModelUpdateView):
