...
IMPORTER_ROLES = [{
    ...
    60,
    'permissions': [
        'IMP_AGENT_APPROVER', 'IMP_SEARCH_CASES_LHS', 'MAILSHOT_RECIPIENT',
    ...
    40,
    'permissions': [
        'IMP_EDIT_APP', 'IMP_SEARCH_CASES_LHS', 'MAILSHOT_RECIPIENT',
        'MANAGE_IMPORTER_ACCOUNT'
    ]
}, {
    'name':
    ...
    50,
    'permissions': [
        'IMP_VARY_APP', 'IMP_SEARCH_CASES_LHS', 'MAILSHOT_RECIPIENT',
        'MANAGE_IMPORTER_ACCOUNT'
    ]
}, {
    'name':
    ...
    30,
    'permissions':
    ['IMP_VIEW_APP', 'IMP_SEARCH_CASES_LHS', 'MAILSHOT_RECIPIENT']
}]
