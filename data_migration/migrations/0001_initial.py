    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("document_legacy_id", models.IntegerField(null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("uref", models.CharField(max_length=16, null=True, unique=True)),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("date_joined_datetime", models.DateTimeField(default=django.utils.timezone.now)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="data_migration.exportapplication",
                    ),
                ),
                (
                    "import_application",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sent_by",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="data_migration.user"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("quantity_amount", models.DecimalField(decimal_places=3, max_digits=14)),
        ...
        migrations.AddField(
            ...
            name="declaration_template_code",
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to="data_migration.template",
                to_field="template_code",
            ),
        ),
        migrations.AddField(
            model_name="importapplicationtype",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("document_pack_id", models.IntegerField(null=True, unique=True)),
                (
                    "ima",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to="data_migration.uniquereference",
                to_field="uref",
            ),
        ),
        migrations.AddField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="data_migration.accessrequest",
                    ),
                ),
                (
                    "closed_by",
        ...
        migrations.AddField(
            ...
            name="created_by",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.PROTECT, to="data_migration.user"
            ),
        ),
        migrations.AddField(
            model_name="file",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="data_migration.casedocument",
                ...
                (
                    "country",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="data_migration.country"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_active", models.BooleanField(default=True)),
                ("type_code", models.CharField(max_length=30, unique=True)),
                ("type", models.CharField(max_length=70)),
        ...
        migrations.CreateModel(
            name="ExportApplicationCountries",
            fields=[
                (
                    "id",
                    models.AutoField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                to="data_migration.exportapplicationtype",
            ),
        ),
        migrations.AddField(
            model_name="exportapplication",
        ...
        migrations.CreateModel(
            name="DocumentPackAcknowledgement",
            fields=[
                (
                    "id",
                    models.AutoField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="data_migration.exportapplicationcertificate",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="acknowledgements",
                        to="data_migration.importapplicationlicence",
                        to_field="document_pack_id",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            name="ConstabularyEmailAttachments",
            fields=[
                (
                    "id",
                    models.AutoField(
                ...
                (
                    "caseemail",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="data_migration.caseemail"
                    ),
                ),
                (
                    "file_target",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.PROTECT, to="data_migration.country"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="data_migration.cfsproduct"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="schedule",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="data_migration.cfsschedule"
            ),
        ),
        migrations.CreateModel(
            name="CFSLegislation",
        ...
        migrations.AddField(
            ...
            name="exporter",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="data_migration.exporter"
            ),
        ),
        migrations.AddField(
            model_name="accessrequest",
        ...
        migrations.AddField(
            ...
            name="importer",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="data_migration.importer"
            ),
        ),
        migrations.AddField(
            model_name="accessrequest",
