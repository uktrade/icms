...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("2014-10-01T01:02:03",), dt.datetime(2014, 10, 1, 0, 2, 3, tzinfo=dt.UTC)),
        (("2022-10-12T12:22:21",), dt.datetime(2022, 10, 12, 11, 22, 21, tzinfo=dt.UTC)),
        (("2008-06-28T18:00:51",), dt.datetime(2008, 6, 28, 17, 0, 51, tzinfo=dt.UTC)),
        (("2022-10-30T01:30:00",), dt.datetime(2022, 10, 30, 0, 30, 0, tzinfo=dt.UTC)),
        ...
        (("2024-07-31", True), dt.datetime(2024, 7, 31, 0, 0, 0, tzinfo=dt.UTC)),
    ],
)
