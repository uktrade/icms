...
SELECT
    ...
    rr.id || '_' || rp.PART_LABEL || '.csv'AS filename,
    'application/csv' AS content_type,
    dbms_lob.getlength(rpo.CLOB_DATA) file_size,
    'REPORTS/LEGACY/' || rr.id || '_' || rp.PART_LABEL || '.csv' AS PATH,
    rp.FINISH_DATETIME AS created_datetime,
    rs.SCHEDULED_BY_WUA_ID AS created_by_id,
    rpo.CLOB_DATA
FROM
    REPORTMGR.REPORT_PARTS_OUTPUTS rpo
...
WHERE
    rp.PART_LABEL NOT IN ('PARAMETER_DATA', 'PARAMETERS')
...
COLUMNS
  ...
  start_date VARCHAR2(50) PATH '/PARAMETER_LIST/PARAMETER[NAME="REPORT_PERIOD"]/VALUE/START_DATE/text()',
  end_date VARCHAR2(50) PATH '/PARAMETER_LIST/PARAMETER[NAME="REPORT_PERIOD"]/VALUE/END_DATE/text()',
  submit_start_date VARCHAR2(50) PATH '/PARAMETER_LIST/PARAMETER[NAME="SUBMIT_PERIOD"]/VALUE/START_DATE/text()',
  submit_end_date VARCHAR2(50) PATH '/PARAMETER_LIST/PARAMETER[NAME="SUBMIT_PERIOD"]/VALUE/END_DATE/text()',
  closed_start_date VARCHAR2(50) PATH '/PARAMETER_LIST/PARAMETER[NAME="CLOSED_PERIOD"]/VALUE/START_DATE/text()',
  closed_end_date VARCHAR2(50) PATH '/PARAMETER_LIST/PARAMETER[NAME="CLOSED_PERIOD"]/VALUE/END_DATE/text()'
) x
