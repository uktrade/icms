...
wood_application = import_application_base.format(
    **{"columns": wood_application_columns, "ima_type": "WD", "process_type": ProcessTypes.WOOD}
)
wood_checklist = import_checklist_base.format(
    **{"columns": wood_checklist_columns, "ima_type": "WD"}
)


# TODO: Find category_licence_description
textiles_application_columns = """
...
textiles_application = import_application_base.format(
    **{
        "columns": textiles_application_columns,
        "ima_type": "TEX",
        "process_type": ProcessTypes.TEXTILES,
    }
)
textiles_checklist = import_checklist_base.format(
    **{"columns": textiles_checklist_columns, "ima_type": "TEX"}
)
