SELECT
	...
	CASE
		...
		WHEN td.TEMPLATE_TYPE = 'CFS_TRANSLATION' THEN TO_CHAR(SUBSTR(XMLSERIALIZE(CONTENT XMLQUERY('//TRANSLATION_BODY/text()' PASSING translation_body RETURNING CONTENT)), 1, 4000))
