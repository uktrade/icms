...
reset_local_db: ## Reset docker database
	./scripts/reset-local-docker-db

end_to_end_test_ci: reset_local_db end_to_end_test ## Run end to end tests in circle ci
...
end_to_end_test_firearm_chief: end_to_end_clear_session ## Ran to send applications to icms-hmrc
