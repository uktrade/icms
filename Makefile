...
collectstatic: ## copies static files to STATIC_ROOT if DEBUG=False then the compressed files will be used by the application
	...
	docker compose run --rm web python ./manage.py compress --engine jinja2 --force
